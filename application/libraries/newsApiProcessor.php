...
function getNewsApiSources(){
    ...
    try {
        ...
        /* execute the cURL */
        $Response['data'] = (array)json_decode(curl_exec($ch));
...
function getNewsApiArticle($source = 'abc-news-au', $sortBy = "sortT"){
    global $endpoints;
    $Response = array(
        "result" => 'success',
        "data" => array(),
    ...
    $endpoint = $endpoints['newsapi']['articles']['endpoint'] . "?source=$source&apiKey=" . NEWSAPI_API_KEY;
    $endpoint .= ("&sortBy=" . $endpoints['newsapi']['articles'][$sortBy]);
